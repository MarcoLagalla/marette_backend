<template>
  <div id="texte_a_afficher" style="padding: 10px;">
...
<p>2. La presente informativa ha valore anche ai fini dell'articolo 13 del Regolamento (UE) n. 2016/679, relativo alla protezione delle persone fisiche con riguardo al trattamento dei dati personali nonché alla libera circolazione di tali dati, per i soggetti che interagiscono con <span >Marette</span> ed è raggiungibile all'indirizzo corrispondente alla pagina iniziale:</p>
<p style="padding-left: 30px;"><span id="span_id_url">marette.ovh</span></p>
<p>3. L'informativa è resa solo per <span>Marette</span> e non anche per altri siti web eventualmente consultati dall'utente tramite link in esso contenuti.</p>
<p>4. Scopo del presente documento è fornire indicazioni circa le modalità, i tempi e la natura delle informazioni che i titolari del trattamento devono fornire agli utenti al momento della connessione alle pagine web di <span id="span_id_sito">Marette</span>, indipendentemente dagli scopi del collegamento stesso, secondo la legislazione Italiana ed Europea.</p>
...
<p style="text-align: center;"><strong><br><br>II - TRATTAMENTO DEI DATI</strong></p>
<p style="text-align: center;"><strong><br>1 - Titolare dei Dati</strong></p>
...
<p>2. Relativamente al presente sito web il titolare del trattamento è: <span id="span_id_titolaretrattamento">Michele Reina</span>, e per ogni chiarimento o esercizio dei diritti dell'utente potrà contattarlo al seguente indirizzo mail: <span><span class="variable_vide">help@marette.ovh</span></span>.</p>
<p style="text-align: center;"><strong><br>2 - Responsabile del trattamento dati</strong></p>
...
<p>2. Ai sensi dell'articolo 28 del regolamento (UE) n. 2016/679, su nomina del titolare del dati, il responsabile del trattamento dei dati del sito <span >Marette</span> è: <span id="span_id_responsabile">Michele Reina</span>. </p>
<p style="text-align: center;"><strong><br>3 - Luogo trattamento dati</strong></p>
<p style="text-align: left;">1. Il trattamento dei dati generato dall'utilizzo di <span>Marette</span> avviene presso <span id="span_id_luogo_titolare">Viale bistoria 4, Pavia</span>.<strong><br></strong></p>
...
<p style="text-align: center;"><strong><br>2 - Cookies tecnici</strong></p>
...
<p style="text-align: center;"><strong><br><br>IV - DATI TRATTATI</strong></p>
<p style="text-align: center;"><strong><br>1 - Modalità trattamento dati</strong></p>
...
<p style="text-align: center;"><strong><br>2 - Finalità del trattamento dati</strong></p>
<p>1. I dati raccolti dal sito durante il suo funzionamento sono utilizzati esclusivamente per le finalità sopra indicate e conservati per il tempo strettamente necessario a svolgere le attività precisate, e comunque non oltre <span id="span_id_periodo_trattamento">1 anno</span>.</p>
<p>2. In ogni caso i dati rilevati dal sito non saranno forniti mai a terzi, per nessuna ragione, a meno che non si tratti di legittima richiesta da parte dell'autorità giudiziaria e nei soli casi previsti dalla legge.</p>
...
<p style="text-align: center;"><strong><br>3 - Dati forniti dall'utente</strong></p>
...
<p style="text-align: center;"><strong><br>4 - Supporto nella configurazione del proprio browser</strong></p>
...
<p style="padding-left: 30px;"><br>- Internet Explorer: http://windows.microsoft.com/en-us/windows-vista/block-or-allow-cookies</p>
...
<p style="text-align: center;"><strong><br>5 - Plugin Social Network</strong></p>
...
<p style="text-align: center;"><strong><br><br>VI - <span class="flou">5885258525858 8855 8 28555 52588 55</span></strong></p>
<p><br><span class="flou">2. 58 25282222 8822 22252882 82258885252 588528 528 5528 55882828 822 8258828 82858822528 58 58 25258 5288'5525 5288'528222 5552225. 52 25528828552 822 222282, 25828222 2 288528222 (28222552) 2552822 8 828858 285282 2 88 82588282 58 222282 825822888. 58 2558225822222 2 55225822522 2 825222522222 52228522 5588'55288282 22, 82225 2 528 82228522222 (55) 5825/588, 225 858 222 2882552 582258252 82282282. 22 5282252 82255 2222822522 255522888222 85 2522585 55288222 58 2588582 558285.</span></p>
<p><span class="flou">5. 822 82555222 258 2558225828 5528 5 25288 22528 852 222 5882222822 82 8225828228 25288822 5588'55288282 22 2 88, 528 82228522222 (55).</span></p>
<p style="text-align: center;"><strong><br><br>VII. SICUREZZA DATI FORNITI</strong></p>
...
<p style="text-align: center;"><strong><br><br>VIII. MODIFICHE AL PRESENTE DOCUMENTO</strong></p>
<p><br>1. Il presente documento, che costituisce la privacy policy di questo sito, è pubblicato all'indirizzo:</p>
<p style="padding-left: 30px;"><span id="span_id_altrourl">marette.ovh/privacy</span></p>
...
<p>4. Il documento è stato aggiornato in data <span id="span_id_data" class="encours">04/06/2020</span> per essere conforme alle disposizioni normative in materia, ed in particolare in conformità al Regolamento (UE) 2016/679.</p>					</div>
</template>
