  ...
  <v-row align="center" class="mx-0 pa-8" justify="center">
    ...
    <div class="rp">
      ...
      <v-form v-if="reset_token" @submit.prevent="compare_token">
        ...
        <v-text-field :error-messages="errors.password" @change="errors.password=''" v-model='password' type="password" label=" Inserire nuova password" id="password" name="password" required></v-text-field>

        <v-text-field :rules="passwordRules" :error-messages="errors.password" @change="errors.password=''" v-model='password2' type="password" label=" Ripeti nuova password" id="password2" name="password2" required></v-text-field>
      ...
      <v-form v-else @submit.prevent="send_email">
        ...
        <v-text-field :rules="emailRules" :error-messages="errors.email" @change="errors.email=''" v-model='email' type="email" label=" Inserire email associata all'account" id="email" name="email" required>
