<template>
  <div>
    ...
    <v-form>
      ...
      <v-text-field solo background-color="#486F83" v-model='category' type="text" placeholder=" Inserire categoria" id="category" name="category" required></v-text-field>
      <v-text-field solo background-color="#486F83" v-model='price' type="text" placeholder=" Inserire prezzo" id="price" name="price" required></v-text-field>
    </v-form>
