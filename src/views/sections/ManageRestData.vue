  ...
  <form @submit.prevent="update">
    <v-row dense>
      ...
      <v-col cols="12" md="6">
        ...
        <picture-input ref="restImage" @change="onChanged" :width="300" :height="300" size="5" zIndex="0" :crop="true" :changeOnClick="false" accept="image/jpeg, image/png, image/gif" buttonClass="ui button primary" :customStrings="{
