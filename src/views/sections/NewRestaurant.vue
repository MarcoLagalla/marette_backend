      ...
      <div class="body">
        ...
        <v-col>
          <v-row align="center" class="ma-0" justify="center">
            ...
            <v-textarea label="Fornisci una breve descrizione del locale*" :error-messages="errors.activity_description" @change="errors.activity_description=''" v-model='activity_description' id="activity_description" rows="3" cols="80"
          ...
          <v-row align="center" class="ma-0" justify="center">
            <v-text-field label="Numero di Telefono valido del locale*" :error-messages="errors.restaurant_number" @change="errors.restaurant_number=''" v-model='restaurant_number' type="tel" id="restaurant_number" name="restaurant_number" required>
            </v-text-field>
